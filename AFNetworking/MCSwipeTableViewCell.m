...
- (void)setupSwipingView {
    ...
    if (isContentViewBackgroundClear) {
        self.contentView.backgroundColor = [UIColor colorWithRed:225.0f/255.0f green:13.0f/255.0f blue:13.0f/255.0f alpha:1.0]; // change
    }
...
- (UIColor *)colorWithPercentage:(CGFloat)percentage {
    ...
    //return color;
    return [UIColor colorWithRed:225.0f/255.0f green:13.0f/255.0f blue:13.0f/255.0f alpha:1.0];
}
