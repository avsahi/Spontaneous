...
- (void)viewDidLoad {
    ...
    self.navigationItem.titleView = [GPUberUtils titleLabelForController:self.navigationController text:@"Contacting Drivers... "];
    ...
    self.pulsingHalo.animationDuration = 1.05;
    self.pulsingHalo.backgroundColor = [UIColor uberBlue].CGColor;
    self.pulsingHalo.radius = 80;
...
- (void)launch {
    [[[self determineStartLocation] continueWithSuccessBlock:^id(BFTask *task) {
        ...
        if (task.error) {
            ...
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops, Error"
            ...
            if ([domain isEqualToString:GP_UBER_VIEW_DOMAIN]) {
                if (code == GPUberViewErrorNetwork) {
                    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops, Network Error"
                                                                    message:@"We're sorry, but there was a problem contacting Uber."
                                                                   delegate:nil
                                                          cancelButtonTitle:@"Okay"
                                                          otherButtonTitles:nil];
                    ...
                    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops, No Service"
                                                                    message:@"We're sorry, but there are no drivers nearby."
                                                                   delegate:nil
                                                          cancelButtonTitle:@"Okay"
                                                          otherButtonTitles:nil];
                    ...
                    title = @"Oops, No Service";
                    message = @"We're sorry, but there are no drivers nearby.";
                } else if (code == GPUberViewErrorLocationUnavailable) {
                    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops, Location Services"
                    ...
                    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops, Distance Error"
                    ...
                    title = @"Oops, Distance Error";
                    message = @"We're sorry, but the requested route is too long.";
                } else if (code == GPUberViewErrorLocationPrePermissionDeclined) {
                    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Oops, Permission Error"
                                                                    message:@"We're sorry, additional authorization needed."
                                                                   delegate:nil
                                                          cancelButtonTitle:@"Okay"
                                                          otherButtonTitles:nil];
...
- (BFTask *)determineStartLocation {
    ...
    // should ask for location permissions?
        ...
        if (status == kCLAuthorizationStatusNotDetermined) {
            ...
            [UIAlertView bk_showAlertViewWithTitle:@"Oops, Location Services"
